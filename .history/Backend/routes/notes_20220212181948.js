...
l  noteTOBEUpdated = Notes.findById(req.params.id) // id given in the parameter
...
noteTOBEUpdated = await Notes.findOneAndUpdate(req.params.id, {$Set : newnote}, {new: true});
